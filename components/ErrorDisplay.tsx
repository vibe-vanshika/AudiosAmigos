...
export const ErrorDisplay: React.FC<ErrorDisplayProps> = ({ message, onDismiss }) => {
  ...
  return (
    <div className={`mb-6 p-4 bg-red-500/10 border border-red-500/20 text-red-200 rounded-xl flex items-center gap-3 transition-opacity duration-1000 ${isFading ? 'opacity-0' : 'opacity-100'}`}>

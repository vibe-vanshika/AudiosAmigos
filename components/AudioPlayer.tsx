...
export const AudioPlayer: React.FC<AudioPlayerProps> = ({ 
  ...
  return (
    <div className="glass-card rounded-lg overflow-hidden animate-slide-up flex flex-col w-full max-w-6xl mx-auto border border-[var(--studio-line)] relative" style={{ animationDelay: '0.1s' }}>

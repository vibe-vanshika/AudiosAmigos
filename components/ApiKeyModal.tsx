...
export const ApiKeyModal: React.FC<ApiKeyModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Modal Content */}
            <div className="bg-black border border-white/10 rounded-2xl w-full max-w-md flex flex-col shadow-2xl relative z-10 animate-scale-up overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex justify-end gap-3 mt-4">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={isSaved}
                            className={`px-6 py-2 rounded-xl text-sm font-bold transition-all flex items-center gap-2 border border-white/10 ${isSaved
